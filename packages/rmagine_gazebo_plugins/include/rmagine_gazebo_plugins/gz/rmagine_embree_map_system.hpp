...
// builds it from Gazebo collision geometry and mutates it in place
// (add/remove/move geometry, then commit()) instead of
...
private:
  ...
  bool IsMovableVisual(gz::sim::Entity entity,
                       const gz::sim::EntityComponentManager &_ecm) const;
